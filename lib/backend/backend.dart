...
/// Functions to query MeasurementRecords (as a Stream and as a Future).
Future<int> queryMeasurementRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MeasurementRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MeasurementRecord>> queryMeasurementRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MeasurementRecord.collection,
      MeasurementRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MeasurementRecord>> queryMeasurementRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
