...
class LocalDetailsWidget extends StatefulWidget {
  const LocalDetailsWidget({
    Key? key,
    required this.documentPage,
  }) : super(key: key);

  final CitiesRecord? documentPage;
...
class _LocalDetailsWidgetState extends State<LocalDetailsWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CitiesRecord>(
      stream: CitiesRecord.getDocument(widget.documentPage!.reference),
      builder: (context, snapshot) {
        ...
        final localDetailsCitiesRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          body: StreamBuilder<CitiesRecord>(
            stream: CitiesRecord.getDocument(widget.documentPage!.reference),
            builder: (context, snapshot) {
              // Customize what your widget looks like when it's loading.
              if (!snapshot.hasData) {
              ...
              final columnCitiesRecord = snapshot.data!;
              return Column(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      widget.documentPage?.cityDescription,
                                      'Descriçao',
                                    ),
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                't87n59x9' /* Additional Details around this... */,
                                              ),
                                              style:
